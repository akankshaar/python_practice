...
face_cascade = cv2.CascadeClassifier('C:\\Users\\Rhea Arora\\Documents\\python\\cnn\\Facial_Recognition\\New folder\\haarcascade_frontalface_default.xml')
iter1=0
while(iter1<num_of_sample):
    ...
    for x,y,w,h in (face):
        ...
        path2 = './image/%d.png'%(iter1) # path to save the image
