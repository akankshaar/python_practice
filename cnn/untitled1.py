...
Original file is located at
    https://colab.research.google.com/drive/1fFqRN3Ggm8thdNiErx6X9HcCicA-SXSn
"""
...
model.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=8, batch_size=100, verbose=2)